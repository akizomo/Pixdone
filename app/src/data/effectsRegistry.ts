...
export const EFFECTS_REGISTRY: EffectDef[] = [
  ...
  { key: 'laserCutter', name: 'Laser Cutter', rarity: 'RARE', themes: ['synthwave'], access: 'premium', description: { en: 'A neon laser slices the task clean in half.', ja: 'ネオンレーザーがタスクを真っ二つに切断。' }, evolutionStages: 1, evolutionCondition: null, evolutionThreshold: null, challengeDeadline: null, challengeUnlockThreshold: null },
