const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    lists: 'Lists',
    plan: 'Plan',
    tutorialFirstTaskPrefill: 'My first task',
    pomodoro: 'Pomodoro',
    ...
    tutorialTask5Before: "Check this month's ",
    tutorialTask5Link: 'Challenge',
    tutorialTask5After: ' and earn a limited effect!',
    priority: 'Priority',
    priorityNone: 'None',
    priorityLow: 'Low',
  ...
  ja: {
    ...
    lists: 'リスト',
    plan: 'プラン',
    tutorialFirstTaskPrefill: '最初のタスク',
    pomodoro: 'ポモドーロ',
    shortBreak: '短い休憩',
    longBreak: '長い休憩',
    startFocus: 'フォーカス開始',
    ...
    tutorialTask5Before: '今月の',
    tutorialTask5Link: 'チャレンジ',
    tutorialTask5After: 'で限定エフェクトを獲得',
    priority: '優先度',
    priorityNone: 'なし',
    priorityLow: '低',
    priorityMedium: '中',
